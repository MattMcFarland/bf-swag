...
const ellipsis = svg(`
<svg xmlns="http://www.w3.org/2000/svg" width="84px" height="84px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" class="uil-ellipsis">
    <circle cx="16" cy="50" r="15" fill="#f17f1a" transform="rotate(0 50 50)">
    ...
    <circle cx="50" cy="50" r="15" fill="#d9d9d9" transform="rotate(0 50 50)">
        <animate id="anir21" attributeName="r" from="15" to="15" begin="0s;anir25.end" dur="0.5s" fill="freeze"/>
    ...
    <circle cx="84" cy="50" r="15" fill="#f17f1a" transform="rotate(0 50 50)">
        <animate id="anir31" attributeName="r" from="15" to="15" begin="0s;anir35.end" dur="0.25s" fill="freeze"/>
    ...
    <circle cx="84" cy="50" r="15" fill="#d9d9d9" transform="rotate(0 50 50)">
